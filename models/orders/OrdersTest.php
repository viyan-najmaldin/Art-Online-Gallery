...
class OrdersTest
{
    ...
    {
        $b1=new art(22,'a1',4556,150,170,'k','jn',140,140);
        $b2=new art(33,'a2',4556,150,170,'k','jn',150,150);
        $b3=new art(44,'a3',4556,150,170,'k','jn',160,160);
     ...
     //  echo "o1 first detail is ".$o1->getOrderDetails()[22]->getQuantity();
      ...
      //print_r($o1->getOrderDetails());
        ...
        foreach ($o1->getOrderDetails()  as $key=>$value){
            echo "this is the data of the detail of art of id $key the amount of order of this details 
            is". $value->getQuantity()."and the remain of this art is ".$value->getart()->getQuantity().
                "the actual remain is ".$value->getart()->getActualQuantity()."<br/>";
        }
