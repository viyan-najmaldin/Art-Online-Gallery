...
class art implements Damage
{
     ...
     * @param $quantity
     */
    public function __construct($id, $name,int $isbn,float $sellPrice,float $buyPrice,string $image,string $description,int $actualQuantity,int $quantity,artist $artist=NULL,Publishers $publisher=NULL, Genre $genre=NULL)
    {
        $this->id = $id;
        $this->name=$name;
        $this->artist = $artist;
    ...
    public function backart ($amount){
